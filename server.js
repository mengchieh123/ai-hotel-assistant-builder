...
        const payload = {
            contents: contents,
            // 🎯 最終修正：根據 REST API v1 的要求，將 systemInstruction 和 generationConfig 放在頂層 config 內
            config: { 
                systemInstruction: systemInstruction, // systemInstruction 必須在 config 內
                generationConfig: { // 模型參數也必須在 generationConfig 內
                    temperature: 0.5,
                    topP: 0.9,
                }
            }
