...
echo "✅ Mock AI 已更新（已整合計算引擎）"

# 提交
git add services/mock-ai-service.js
git commit -m "fix: integrate booking calculator into Mock AI service

Critical fix:
✅ Mock AI now properly uses booking-calculator module
✅ Extracts booking info from natural language
✅ Calculates price using calculator engine
✅ Returns detailed breakdown to users

This enables intelligent price calculation in conversations.

Before: null responses
After: Full price breakdown with itemized details"
...
curl -s -X POST https://ai-hotel-assistant-builder-production.up.railway.app/api/ai/chat \
  -H "Content-Type: application/json" \
  -d '{"message": "豪華客房，住3晚，2大人1小孩8歲，含早餐，計算總價"}' | jq -r '.message'
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "如果仍顯示 null，請檢查 Railway 日誌："
